...
class HybridRecommender:
    """
    Sistema hibrido de recomendacao:
    - Usuarios com poucas avaliacoes: recebe os filmes mais bem avaliados (best sellers por rating)
    - Usuarios com historico suficiente: recebe recomendacoes personalizadas por
      similaridade de cossenos ponderada pela nota (rating) do proprio usuario
    """
    ...
    def get_user_stats(self, user_id: int) -> dict:
        ...
        if len(user_ratings) == 0:
            return {
                ...
                "total_ratings": 0,
                "avg_rating": 0.0,
                "recommendation_strategy": "nenhuma"
            }

        strategy = "popular" if len(user_ratings) < self.min_ratings_threshold else "similaridade"
