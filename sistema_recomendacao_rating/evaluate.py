...
def main():
    ...
    print("(Limiar de relevancia: rating >= 4.0)")
    ...
    print(f"  (Variedade de filmes recomendados entre usuarios - baseada em Jaccard)")

    print_separator()
    print("Interpretacao dos resultados:")
    print("\nPrecision@K: Proporcao de itens recomendados com rating >= 4.0 no conjunto de teste")
    ...
    print("\nRecall@K: Proporcao de itens bem avaliados que foram recomendados")
    print("  - Mede a capacidade de encontrar todos os itens relevantes")
    print("  - Trade-off com precision: aumentar K aumenta recall mas pode diminuir precision")
    ...
    print("\nDiversidade: Variedade entre recomendacoes de diferentes usuarios (Jaccard)")
    print("  - Valores proximos de 1.0 = alta personalizacao (cada usuario recebe sugestoes diferentes)")
